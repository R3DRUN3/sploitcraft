...
Within the PPE approach, attackers deploy malicious code within the CI component of the CI/CD pipeline, circumventing the need for direct CI/CD system access.  
This tactic involves manipulating permissions within a source code management (SCM) repository.  
