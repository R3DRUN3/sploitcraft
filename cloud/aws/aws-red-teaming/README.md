...
> it is highly recommended to [*set up a proxy*](https://hackingthe.cloud/aws/avoiding-detection/guardduty-pentest/) to route AWS calls and modify the user agent. 
